      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6 sm:mb-8">
            <h3 className="text-xl sm:text-2xl font-bold">Categorias Principais</h3>
          </div>
        ...
        <section className="mt-12 sm:mt-20 bg-white/10 rounded-2xl p-6 sm:p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8 border border-white/20">
          <div className="max-w-md text-center md:text-left">
            <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Mantenha-se Operacional</h3>
          ...
          <div className="flex flex-col sm:flex-row w-full md:w-auto gap-2">
            <input 
              ...
              className="bg-[#050505]/50 border border-white/20 rounded-lg px-4 py-3 w-full sm:w-64 focus:ring-2 focus:ring-[#2e3e2e] focus:border-transparent outline-none text-white text-sm"
            />
            <button className="bg-[#2e3e2e] text-white px-6 py-3 rounded-lg font-bold hover:brightness-110 transition-all text-sm whitespace-nowrap">
              Assinar
            </button>
          </div>
        </section>
